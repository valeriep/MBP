...
public class FileHelper {
    ...
    /**
     * Returns the real path of the given URI string. If the given URI string represents a content:// URI, the real path is retrieved from the media store.
     * 
     * @param uriString
    ...
    /**
     * Returns the real path of the given URI. If the given URI is a content:// URI, the real path is retrieved from the media store.
     * 
     * @param uri
