...
public class Globalization extends CordovaPlugin {
    ...
    /*
     * @Description: Returns a date formatted as a string according to the client's user preferences and calendar using the time zone of the client.
     * 
    ...
    /*
     * @Description: Parses a date formatted as a string according to the client's user preferences and calendar using the time zone of the client and returns the corresponding
     * date object
     * 
     * @Return: JSONObject Object.year {Number}: The four digit year Object.month {Number}: The month from (0 - 11) Object.day {Number}: The day from (1 - 31) Object.hour {Number}:
     * The hour from (0 - 23) Object.minute {Number}: The minute from (0 - 59) Object.second {Number}: The second from (0 - 59) Object.millisecond {Number}: The milliseconds (from
     * 0 - 999), not available on all platforms
     * 
    ...
    /*
     * @Description: Returns a pattern string for formatting and parsing dates according to the client's user preferences.
     * 
     * @Return: JSONObject
     * 
     * Object.pattern {String}: The date and time pattern for formatting and parsing dates. The patterns follow Unicode Technical Standard #35
     * http://unicode.org/reports/tr35/tr35-4.html Object.timezone {String}: The abbreviated name of the time zone on the client Object.utc_offset {Number}: The current difference
     * in seconds between the client's time zone and coordinated universal time. Object.dst_offset {Number}: The current daylight saving time offset in seconds between the client's
     * non-daylight saving's time zone and the client's daylight saving's time zone.
     * 
    ...
    /*
     * @Description: Returns an array of either the names of the months or days of the week according to the client's user preferences and calendar
     * 
     * @Return: JSONObject Object.value {Array{String}}: The array of names starting from either the first month in the year or the first day of the week.
     * 
     * @throws: GlobalizationError.UNKNOWN_ERROR
     */
    @TargetApi(9)
    ...
    /*
     * @Description: Returns whether daylight savings time is in effect for a given date using the client's time zone and calendar.
     * 
     * @Return: JSONObject Object.dst {Boolean}: The value "true" indicates that daylight savings time is in effect for the given date and "false" indicate that it is not. *
     * 
     * @throws: GlobalizationError.UNKNOWN_ERROR
     */
    ...
    /*
     * @Description: Returns the first day of the week according to the client's user preferences and calendar. The days of the week are numbered starting from 1 where 1 is
     * considered to be Sunday.
     * 
     * @Return: JSONObject Object.value {Number}: The number of the first day of the week.
     * 
     * @throws: GlobalizationError.UNKNOWN_ERROR
     */
    ...
    /*
     * @Description: Parses a number formatted as a string according to the client's user preferences and returns the corresponding number.
     * 
    ...
    /*
     * @Description: Returns a pattern string for formatting and parsing numbers according to the client's user preferences.
     * 
     * @Return: JSONObject Object.pattern {String}: The number pattern for formatting and parsing numbers. The patterns follow Unicode Technical Standard #35.
     * http://unicode.org/reports/tr35/tr35-4.html Object.symbol {String}: The symbol to be used when formatting and parsing e.g., percent or currency symbol. Object.fraction
     * {Number}: The number of fractional digits to use when parsing and formatting numbers. Object.rounding {Number}: The rounding increment to use when parsing and formatting.
     * Object.positive {String}: The symbol to use for positive numbers when parsing and formatting. Object.negative: {String}: The symbol to use for negative numbers when parsing
     * and formatting. Object.decimal: {String}: The decimal symbol to use for parsing and formatting. Object.grouping: {String}: The grouping symbol to use for parsing and
     * formatting.
     * 
     * @throws: GlobalizationError.PATTERN_ERROR
     */
    ...
    /*
     * @Description: Returns a pattern string for formatting and parsing currency values according to the client's user preferences and ISO 4217 currency code.
     * 
     * @Return: JSONObject Object.pattern {String}: The currency pattern for formatting and parsing currency values. The patterns follow Unicode Technical Standard #35
     * http://unicode.org/reports/tr35/tr35-4.html Object.code {String}: The ISO 4217 currency code for the pattern. Object.fraction {Number}: The number of fractional digits to
     * use when parsing and formatting currency. Object.rounding {Number}: The rounding increment to use when parsing and formatting. Object.decimal: {String}: The decimal symbol
     * to use for parsing and formatting. Object.grouping: {String}: The grouping symbol to use for parsing and formatting.
     * 
     * @throws: GlobalizationError.FORMATTING_ERROR
     */
